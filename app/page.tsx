      ...
      <header className="border-b border-slate-200 bg-white/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6">
            <a href="#how-it-works" className="text-slate-600 hover:text-primary-600 transition">
              How it Works
            </a>
            <a href="#privacy" className="text-slate-600 hover:text-primary-600 transition">
              Privacy
            </a>
          </nav>
        </div>
      ...
      <main>
        <section className="max-w-6xl mx-auto px-4 pt-20 pb-32">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <button
              ...
              className="inline-flex items-center gap-3 bg-primary-600 hover:bg-primary-700 text-white px-8 py-4 rounded-xl text-lg font-semibold transition-all hover:shadow-lg hover:shadow-primary-600/25 active:scale-[0.98]"
            >
          ...
          <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 text-center">
              <div className="text-4xl font-bold text-primary-600 mb-2">$240</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-slate-600">
                  Securely connect your Gmail with read-only OAuth access. We only look at subscription-related emails.
                </p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-primary-100 rounded-2xl flex items-center justify-center mx-auto mb-4">
                ...
                <p className="text-slate-600">
                  Our AI analyzes your emails from the last 12 months to find recurring charges and subscriptions.
                </p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-primary-100 rounded-2xl flex items-center justify-center mx-auto mb-4">
                ...
                <p className="text-slate-600">
                  See all your subscriptions in one place with costs, renewal dates, and activity indicators.
                </p>
              </div>
            </div>
          </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 text-sm">
                      We only request permission to read emails, never to modify or delete anything.
                    </p>
                  </div>
                </div>
              </div>
              <div className="bg-white rounded-xl p-6 border border-slate-100 shadow-sm">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 text-sm">
                      We never store full email content. Only extracted subscription info is cached locally.
                    </p>
                  </div>
                </div>
              </div>
              <div className="bg-white rounded-xl p-6 border border-slate-100 shadow-sm">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 text-sm">
                      You can revoke access instantly from your Google account settings.
                    </p>
                  </div>
                </div>
              </div>
              <div className="bg-white rounded-xl p-6 border border-slate-100 shadow-sm">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 text-sm">
                      OAuth tokens are encrypted and automatically expire. Your credentials stay secure.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="py-20 bg-gradient-to-br from-primary-600 to-primary-700">
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            <button
              onClick={handleConnectGmail}
              className="inline-flex items-center gap-3 bg-white hover:bg-slate-50 text-primary-600 px-8 py-4 rounded-xl text-lg font-semibold transition-all hover:shadow-lg active:scale-[0.98]"
            >
              <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
                <path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" />
                <path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" />
